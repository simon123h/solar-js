...
import createSolarSystem from "../src/universes/solar-system";
import createGalaxyCollision from "../src/universes/galaxy-collision";
import createNBodyUniverse from "../src/universes/n-body-universe";
